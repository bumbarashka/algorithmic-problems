...
public class Solution002Test {
    ...
    public void addTwoNumbers() throws Exception {
        ...
        assertArrayEquals(new Integer[]{7, 0, 8}, listToArray(new Solution002().addTwoNumbers(l1, l2)));
        ...
        assertArrayEquals(new Integer[]{9, 2, 7, 1, 1, 2, 3, 7, 1, 2}, listToArray(new Solution002().addTwoNumbers(l1, l2)));
        ...
        assertArrayEquals(new Integer[]{0, 5, 8, 1, 5, 1, 2, 9, 1, 1}, listToArray(new Solution002().addTwoNumbers(l1, l2)));
    }
